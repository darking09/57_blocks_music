...
export const MSG_EMPTY_REQUEST = 'Please. Send you information to register.';
export const MSG_EMAIL_FORMAT = 'Please. Send an email with a format valid.';
...
export const MSG_SONG_UPDATE_SUCCEED = "Ths song $SONG_NAME was updated";
